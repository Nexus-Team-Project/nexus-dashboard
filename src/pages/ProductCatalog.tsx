    ...
    <main className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 bg-primary shadow-sm hover:opacity-90 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-opacity"
          aria-label={t('bp_createOffer')}
        >
