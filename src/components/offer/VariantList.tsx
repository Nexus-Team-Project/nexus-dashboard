        ...
        return (
          ...
          >
            <div className="min-w-0">
              ...
              {incomplete && (
                <span className="mt-1.5 inline-flex items-center gap-1 rounded-full bg-red-50 px-2.5 py-1 text-xs font-medium text-red-700 dark:bg-red-900/20 dark:text-red-400">
