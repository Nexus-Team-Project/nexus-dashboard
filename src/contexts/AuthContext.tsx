...
const AUTH_URL = import.meta.env.VITE_AUTH_URL ?? import.meta.env.VITE_API_URL ?? 'http://localhost:3001';
const WEBSITE_URL = import.meta.env.VITE_WEBSITE_URL ?? (import.meta.env.PROD ? 'https://nexus-payment.com' : 'http://localhost:3000');
