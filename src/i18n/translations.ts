export const translations = {
  en: {
    ...
    mc_greeting: 'Welcome back',
    mc_viewOffer: 'View offer',
    mc_infoTitle: 'Heads up',
    mc_infoBody: 'Offers below are curated for your workspace. Tap any card to view full details and redeem.',
    mc_clubWelcome: 'Members only',
    mc_clubTitle: 'Welcome to your exclusive benefits club',
    mc_clubCta: 'Specially curated offers - scroll to discover them all',
    mc_urgencyText: 'Hurry! Limited-time and limited-stock offers.',
    mc_updatedJustNow: '(updated just now)',
    mc_updatedMinutesAgo: '(updated {n} min ago)',
    mc_searchClubPlaceholder: 'Search brand or offer... (e.g. sports, travel)',
    mc_searchClubPlaceholderShort: 'Search offer...',
    mc_viewBenefit: 'View benefit',
    mc_typeVoucher: 'Voucher',
    mc_typeCoupon: 'Coupon',
    mc_typeGiftCard: 'Gift card',
    mc_typeProduct: 'Product',
    mc_typeService: 'Service',
    mc_expiresToday: 'Expires today',
    mc_expiresInDays: 'Expires in {n} days',
    mc_soldOut: 'Sold out',
    mc_filtersButton: 'Filters',
    mc_filtersTitle: 'Filter offers',
    mc_filtersCategory: 'Category',
    mc_filtersOfferType: 'Offer type',
    mc_filtersStartDate: 'Start date',
    mc_filtersExpiry: 'Expiry',
    mc_filtersPrice: 'Price (₪)',
    mc_filtersTags: 'Tags',
    mc_filtersInStockOnly: 'In stock only',
    mc_filtersSortBy: 'Sort by',
    mc_filtersSortDefault: 'Default',
    ...
    mc_filtersApply: 'Apply filters',
    mc_filtersReset: 'Clear all',
    mc_filtersFrom: 'From',
    mc_filtersTo: 'To',
    mc_filtersMin: 'Min',
    mc_filtersMax: 'Max',
    mc_filtersAllCategories: 'All categories',
    mc_filtersActive: '{n} active',
    mc_filtersClose: 'Close filters',
    mc_discountFormat: '{pct}% off on {title}',
    mc_prevSlide: 'Previous',
    mc_nextSlide: 'Next',
  ...
  he: {
    ...
    mc_greeting: 'ברוך שובך',
    mc_viewOffer: 'צפייה בהטבה',
    mc_infoTitle: 'לתשומת לבך',
    mc_infoBody: 'ההטבות שלהלן נבחרו במיוחד עבור סביבת העבודה שלך. הקש על כל כרטיס לפרטים מלאים ולמימוש.',
    mc_clubWelcome: 'למנויים בלבד',
    mc_clubTitle: 'ברוכים הבאים למועדון ההטבות הבלעדי שלך',
    mc_clubCta: 'הצעות מיוחדות שנבחרו עבורך - גלול כדי לגלות הכל',
    mc_urgencyText: 'מהרו! הצעות לזמן מוגבל ומלאי מוגבל.',
    mc_updatedJustNow: '(עודכן זה עתה)',
    mc_updatedMinutesAgo: '(עודכן לפני {n} דק׳)',
    mc_searchClubPlaceholder: 'חפש מותג או הצעה... (למשל: ספורט, נסיעות)',
    mc_searchClubPlaceholderShort: 'חפש הטבה...',
    mc_viewBenefit: 'צפה בהטבה',
    mc_typeVoucher: 'שובר',
    mc_typeCoupon: 'קופון',
    mc_typeGiftCard: 'כרטיס מתנה',
    mc_typeProduct: 'מוצר',
    mc_typeService: 'שירות',
    mc_expiresToday: 'פג תוקף היום',
    mc_expiresInDays: 'פג תוקף בעוד {n} ימים',
    mc_soldOut: 'אזל המלאי',
    mc_filtersButton: 'סינון',
    mc_filtersTitle: 'סנן הטבות',
    mc_filtersCategory: 'קטגוריה',
    mc_filtersOfferType: 'סוג ההטבה',
    mc_filtersStartDate: 'תאריך התחלה',
    mc_filtersExpiry: 'תוקף',
    mc_filtersPrice: 'מחיר (₪)',
    mc_filtersTags: 'תגיות',
    mc_filtersInStockOnly: 'במלאי בלבד',
    mc_filtersSortBy: 'מיון לפי',
    mc_filtersSortDefault: 'ברירת מחדל',
    ...
    mc_filtersApply: 'החל סינון',
    mc_filtersReset: 'נקה הכל',
    mc_filtersFrom: 'מתאריך',
    mc_filtersTo: 'עד תאריך',
    mc_filtersMin: 'מינימום',
    mc_filtersMax: 'מקסימום',
    mc_filtersAllCategories: 'כל הקטגוריות',
    mc_filtersActive: '{n} פעילים',
    mc_filtersClose: 'סגור סינון',
    mc_discountFormat: '{pct}% הנחה על {title}',
    mc_prevSlide: 'הקודם',
    mc_nextSlide: 'הבא',
