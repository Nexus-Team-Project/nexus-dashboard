export const translations = {
  en: {
    ...
    vxi_browse: 'Choose an Excel file',
    vxi_orDrag: ' or drag it here',
    vxi_fileTypes: 'Accepts .xlsx and .xls',
    vxi_readError: 'Could not read this file. Upload a valid .xlsx or .xls.',
    ...
    vxi_stackTooMany: 'The combine-with-promotions column has more than 2 different values. It can only mean yes or no - fix the column or leave it unmapped.',
  ...
  he: {
    ...
    vxi_import: 'ייבוא',
    vxi_importCsv: 'CSV',
    vxi_importXlsx: 'אקסל (XLSX)',
    vxi_csvSoon: 'בקרוב',
    vxi_step1: 'שלב 1 מתוך 3',
    vxi_step2: 'שלב 2 מתוך 3',
    vxi_uploadTitle: 'ייבוא שוברים מאקסל',
    vxi_uploadDesc: 'כל שורה הופכת לקוד שובר אחד. שורות עם אותו שווי, מחיר מכירה וכפל מבצעים מקובצות לאותו וריאנט.',
    vxi_browse: 'בחירת קובץ אקסל',
    vxi_orDrag: ' או גררו לכאן',
    vxi_fileTypes: 'תומך ב-‎.xlsx ו-‎.xls',
    vxi_readError: 'לא ניתן לקרוא את הקובץ. העלו קובץ ‎.xlsx או ‎.xls תקין.',
    ...
    vxi_stackTooMany: 'בעמודת כפל המבצעים יש יותר מ-2 ערכים שונים. היא יכולה לסמן רק כן או לא - תקנו את העמודה או השאירו אותה לא ממופה.',
