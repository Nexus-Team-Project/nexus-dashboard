export const translations = {
  en: {
    ...
    // Voucher CSV bulk upload.
    vb_modeManual: 'Manual',
    vb_modeCsv: 'CSV bulk upload',
    vb_title: 'Bulk upload vouchers',
    vb_emptyHint: 'Each row is one voucher. Download the template to see the columns.',
    vb_downloadTemplate: 'Download CSV template',
    vb_chooseFile: 'Choose CSV file',
    vb_headerMissing: 'Missing required columns',
    vb_backToCatalog: 'Back to catalog',
    vb_colTitle: 'Title',
    vb_colPrice: 'Face / Nexus',
    vb_colCombinable: 'Combine',
    vb_colVisibility: 'Visibility',
    vb_colBackground: 'Background',
    vb_colInventory: 'Inventory',
    vb_colStatus: 'Status',
    vb_valid: 'Valid',
    vb_invalid: 'Invalid',
    vb_bgImage: 'Image',
    vb_bgColor: 'Color',
    vb_bgTenant: 'Org default',
    vb_publish: 'Publish valid rows',
    vb_publishing: 'Publishing…',
    vb_created: 'created',
    vb_failed: 'failed',
    co_fieldSku: 'SKU',
  ...
  he: {
    ...
    // Voucher CSV bulk upload.
    vb_modeManual: 'ידני',
    vb_modeCsv: 'העלאת CSV מרובה',
    vb_title: 'העלאת שוברים מרובה',
    vb_emptyHint: 'כל שורה היא שובר אחד. הורידו את התבנית כדי לראות את העמודות.',
    vb_downloadTemplate: 'הורדת תבנית CSV',
    vb_chooseFile: 'בחירת קובץ CSV',
    vb_headerMissing: 'חסרות עמודות חובה',
    vb_backToCatalog: 'חזרה לקטלוג',
    vb_colTitle: 'כותרת',
    vb_colPrice: 'שווי / נקסוס',
    vb_colCombinable: 'כפל מבצעים',
    vb_colVisibility: 'נראות',
    vb_colBackground: 'רקע',
    vb_colInventory: 'מלאי',
    vb_colStatus: 'סטטוס',
    vb_valid: 'תקין',
    vb_invalid: 'לא תקין',
    vb_bgImage: 'תמונה',
    vb_bgColor: 'צבע',
    vb_bgTenant: 'ברירת מחדל של הארגון',
    vb_publish: 'פרסום שורות תקינות',
    vb_publishing: 'מפרסם…',
    vb_created: 'נוצרו',
    vb_failed: 'נכשלו',
