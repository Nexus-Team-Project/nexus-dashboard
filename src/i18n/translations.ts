export const translations = {
  en: {
    ...
    vxi_mapDesc: 'Match your spreadsheet headers to the voucher fields. Map Value or Sale price, plus Barcode, to continue.',
    ...
    vxi_fieldDate: 'Expiry date',
    vxi_optional: 'optional',
    vxi_needRequired: 'Map Value (or Sale price) and Barcode to continue.',
    vxi_readyToReview: 'Ready - review the variants next.',
    ...
    vxi_toastNoRows: 'No valid rows found in this file.',
    vxi_toastDupBarcodes: 'duplicate barcodes in the file - fix them before publishing',
    vxi_toastSkipped: 'rows skipped (missing value, sale price, or barcode)',
    co_fieldSku: 'SKU',
  ...
  he: {
    ...
    vxi_mapDesc: 'התאימו את כותרות הגיליון לשדות השובר. כדי להמשיך, מפו שווי או מחיר מכירה, וכן ברקוד.',
    vxi_voucherFields: 'שדות השובר',
    vxi_fieldValue: 'שווי',
    vxi_fieldSalePrice: 'מחיר מכירה',
    vxi_fieldStackable: 'כפל מבצעים',
    vxi_fieldBarcode: 'ברקוד',
    vxi_fieldDate: 'תאריך תפוגה',
    vxi_optional: 'רשות',
    vxi_needRequired: 'מפו שווי (או מחיר מכירה) וברקוד כדי להמשיך.',
    vxi_readyToReview: 'מוכן - נעבור לסקירת הוריאנטים.',
    ...
    vxi_toastNoRows: 'לא נמצאו שורות תקינות בקובץ.',
    vxi_toastDupBarcodes: 'ברקודים כפולים בקובץ - תקנו אותם לפני הפרסום',
    vxi_toastSkipped: 'שורות דולגו (חסר שווי, מחיר מכירה או ברקוד)',
