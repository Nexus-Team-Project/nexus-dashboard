export const translations = {
  en: {
    ...
    vi_quantityLabel: 'Quantity',
    vi_addLink: 'Add link',
    vi_removeLink: 'Remove link',
    vi_barcodesHint: 'We will generate this many codes for the voucher.',
    vi_skip: 'Skip',
    vi_insert: 'Insert barcodes/links',
    vi_errQuantity: 'Enter a quantity between 1 and 10000.',
  ...
  he: {
    ...
    vi_quantityLabel: 'כמות',
    vi_addLink: 'הוסף לינק',
    vi_removeLink: 'הסר לינק',
    vi_barcodesHint: 'ניצור עבור השובר כמות זו של קודים.',
    vi_skip: 'דלג',
    vi_insert: 'הכנס ברקודים/לינקים',
    vi_errQuantity: 'יש להזין כמות בין 1 ל-10000.',
